...
public class ForgotPasswordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void changePassoword() throws IOException {
        ...
        String url = Util.SERVERAPI + "api?appid=$2y$12$esyosghhXSh6LxcX17N/suiqeJGJq/VQ9QkbqvImtE4JMWxz7WqYS&opt=user_param&act=forget_password&phone=" + mPhone + "&password=" + pass.getText();
    ...
    public void checkPhone() throws IOException {
        // api?appid=&opt=register_user&phone=&password=&name=
        String url = Util.SERVERAPI + "api?appid=$2y$12$esyosghhXSh6LxcX17N/suiqeJGJq/VQ9QkbqvImtE4JMWxz7WqYS&opt=user_param&act=check_phone&phone="
                + mPhone;
